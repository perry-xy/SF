...
class ResultFormat():
    ...
    def rdc_post_process(self):
        ...
        for rdc_name in rdc_open_valid:
            ...
            rdc_output['Total_Cost'] = rdc_output['CDC_Shipping_Cost'] + rdc_output['Shipping_Cost'] + rdc_output['Storage_Cost'] + \
    ...
    def performance(self,m):
        ...
        rdc_shipping_cost, rdc_shipping_cost_d, rdc_shipping_distance, shipping_diistance_d= self.model_result.rdc_shipping_cost(self.model_result.r_c)
        # rdc_shipping_cost, rdc_shipping_cost_d, rdc_shipping_distance, shipping_diistance_d \
        ...
        #performance_output['Trunk_cost'] = shipping_cost_trunk
        performance_output['Rdc_cus_cost'] = rdc_shipping_cost
        ...
        performance_output['Total_Cost'] = performance_output['Trans_cost'] + performance_output['Rdc_cus_cost'] \
        ...
        performance_output['RDC_Shipping_Distance'] = rdc_shipping_distance

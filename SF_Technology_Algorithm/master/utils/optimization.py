...
class Optimization(object):
    ...
    def cost_json(self, day,strategy):
        ...
        for zone, employees in strategy.items():
            ...
            demand_r = self.data.demands[datetime.strptime(day, '%Y-%m-%d')][zone]['receive']
            demand_s = self.data.demands[datetime.strptime(day, '%Y-%m-%d')][zone]['send']
...
optimization = Optimization(data_ins,r'..\results\solution.json')
